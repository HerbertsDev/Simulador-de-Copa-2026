# sorteia gols aleatórios em um banco de dados implementado no python.
import random
import sqlite3

# cria o arquivo do banco. o cursor é como se fosse uma caneta para escrever.
def criar_banco():
